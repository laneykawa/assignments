...
In this assigment we took a input and used state to store the names in a list. 

The Form and Display were two separate components that pulled in the name value passed through props. 
